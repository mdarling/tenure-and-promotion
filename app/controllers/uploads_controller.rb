class UploadsController < ApplicationController
  # GET /uploads
  def index 
    pdf_file_paths = [ "public/About_Downloads.pdf", "public/About_Stacks.pdf"]
Prawn::Document.generate("public/result.pdf", {:page_size => 'A4', :skip_page_creation => true}) do |pdf|
