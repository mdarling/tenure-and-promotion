...
class CommitteesControllerTest < ActionController::TestCase
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post :create, committee: { committee_id: @committee.committee_id, department_college_id: @committee.department_college_id, department_id: @committee.department_id, name: @committee.name }
    end
  ...
  test "should update committee" do
    patch :update, id: @committee, committee: { committee_id: @committee.committee_id, department_college_id: @committee.department_college_id, department_id: @committee.department_id, name: @committee.name }
    assert_redirected_to committee_path(assigns(:committee))
  end
